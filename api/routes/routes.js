...
const getCustomerContactDetails = require("./getCustomerContactDetails"); //http://localhost:4000/getCustomerContactDetails.do
...
router.use("/getCustomerContactDetails.do", getCustomerContactDetails);
